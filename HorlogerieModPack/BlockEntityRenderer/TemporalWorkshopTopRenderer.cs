...
namespace HorlogerieModPack.BlockEntityRenderer
{
    //public class TemporalWorkshopTopRenderer : IRenderer
    //{
    ...
    //    public TemporalWorkshopTopRenderer(ICoreClientAPI coreClientAPI, BlockPos pos, MeshData mesh)
    //    {
